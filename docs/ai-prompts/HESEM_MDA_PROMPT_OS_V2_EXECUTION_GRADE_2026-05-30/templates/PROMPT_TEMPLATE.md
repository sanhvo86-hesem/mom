...
## Prompt-specific block

- Prompt ID:
- Title:
- Mode:
- Required previous token:
- Unlock token:
- Domain affected:
- Files allowed:
- Files forbidden:
...
Follow the common execution constitution and the prompt-specific tasks. Do not skip audit, adversarial review, simulation, repair, verification, or handoff.
