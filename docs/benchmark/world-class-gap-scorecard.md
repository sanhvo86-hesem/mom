...
| AI / copilot architecture quality | 3.3 | 4.2 | 4.5 | Legacy AI reads now require AI read roles, feedback requires feedback/write roles, and schedule metrics are plant-scoped. |
