...
const EXPLICIT_WORKFLOW_ENGINE_BRIDGES = Object.freeze({
  ...
  wf_cnc_program_approval: { record_type: 'CNC_PROGRAM_APPROVAL', identity_candidates: ['record_id', 'source_record_id'] },
  ...
  wf_dw_supplier_dim: { record_type: 'DW_SUPPLIER_DIM', identity_candidates: ['record_id', 'source_record_id'] },
  ...
  wf_integration_monitor: { record_type: 'INTEGRATION_MONITOR', identity_candidates: ['record_id', 'source_record_id'] },
  wf_item: { record_type: 'ITEM', identity_candidates: ['record_id', 'source_record_id'] },
  wf_job_order: { record_type: 'JOB_ORDER', identity_candidates: ['record_id', 'source_record_id'] },
  ...
  wf_product_passport: { record_type: 'PRODUCT_PASSPORT', identity_candidates: ['record_id', 'source_record_id'] },
  wf_project_milestone: { record_type: 'PROJECT_MILESTONE', identity_candidates: ['record_id', 'source_record_id'] },
  wf_purchase_order: { record_type: 'PURCHASE_ORDER', identity_candidates: ['record_id', 'source_record_id'] },
  ...
  wf_quote_lifecycle: { record_type: 'QUOTE_LIFECYCLE', identity_candidates: ['record_id', 'source_record_id'] },
  wf_receiving_inspection: { record_type: 'RECEIVING_INSPECTION', identity_candidates: ['record_id', 'source_record_id'] },
  wf_record_lifecycle: { record_type: 'RECORD_LIFECYCLE', identity_candidates: ['record_id', 'source_record_id'] },
  wf_retention_policy: { record_type: 'RETENTION_POLICY', identity_candidates: ['record_id', 'source_record_id'] },
  wf_routing: { record_type: 'ROUTING', identity_candidates: ['record_id', 'source_record_id'] },
  wf_sales_order: { record_type: 'SALES_ORDER', identity_candidates: ['record_id', 'source_record_id'] },
