...
const dataConfigPath = path.join(repo, '01-QMS-Portal', 'scripts', 'portal', '01-data-config.js');
const scenariosPath = path.join(repo, '01-QMS-Portal', 'qms-data', 'config', 'portal-access-regression-scenarios.json');
const visibilityPath = path.join(repo, '01-QMS-Portal', 'qms-data', 'config', 'docs_visibility.json');
const customDocsPath = path.join(repo, '01-QMS-Portal', 'qms-data', 'config', 'docs_custom.json');
const rolePermsPath = path.join(repo, '01-QMS-Portal', 'qms-data', 'config', 'role_permissions.json');
const descPath = path.join(repo, '01-QMS-Portal', 'qms-data', 'config', 'doc_descriptions.json');
...
const outPath = path.join(repo, '01-QMS-Portal', 'docs', 'portal-access-regression-results-phase2f.json');
