...
- This file should not be used to legitimize mass content upgrades following the same set of sample sentences.
- Graphics, palettes, table formats and HTML skeletons can be standardized to a core-standard level.
...
| 4 | Roles, authorities & RACI | Role table or RACI matrix, but must clearly show block/unhold authority |
...
| 8 | Exceptions, changes & redo | The exception table holds/restart/revalidation/change path |
| 9 | Systems, records & data | Table mapping: System -> Data -> Responsibility -> Storage |
| 10 | Forms, WI, SOP & JD associated | Document code table + name + link |
...
| 2 | Scope & object of application | Applies to whom, where, and when |
| 3 | Necessary tools, supplies & documents | List of tools, supplies, and reference documents |
| 4 | Prerequisites | Conditions MUST be met before starting |
| 5 | Implementation steps | Step-by-step, 1 action per step |
| 6 | Records & evidence | What records need to be recorded and where should they be saved? |
...
### Principles of writing WI

- Every step STARTS with an imperative verb: "Set", "Open", "Test", "Record", "Report".
...
| Ingredient | Describe | Obligatory |
|-----------|-------|---------|
| iso-map | Clause linkage table ISO 9001/AS9100D | RIGHT |
| Sections | Content sections, numbered | RIGHT |
| Tables | Data tables, rules, matrices | MUST (minimum 1) |
| Header (meta) | Ma, rev, effect, owner | RIGHT |

### ANNEX forms

| Form | For example | Characteristic |
|------|-------|---------|
| Reference data | ANNEX-302 Approved Materials List | By listing, there is a filter |
...
| Map | ANNEX-106 ISO 9001 Matrix Full | Clause -> documents -> responsibility |
| Topology | ANNEX-133 M365 Site Topology | Directory, site, library structure |
...
### Nguyen works on ANNEX

- DO NOT write properly. Dung state and list.
- Every table MUST have a clear header.
- Record source/source for each rule (ISO clause, standard, customer requirement).
- Name sections based on content, not based on revenue.
...
|---------|---------|-----------|---------|
| 1 | Purpose & sum menh | `jd-purpose`, `jd-mission` | 2-3 questions: What is the purpose of this situation? |
| 2 | Main responsibilities | `resp-table` | Table: STT \| Responsibility \| Frequency\| File |
| 3 | Competence | `auth-grid` | Table: Decision \| Range \| Limit \| Report to |
| 4 | Always love you | `comp-grid` | State: Capable at any time \| Cause (Dreyfus) \| Required/Premium |
...
- The Auth-grid records the limit: "Application for PO under $5,000" instead of "Application for PO".
...
| 3 | Organizational chart | Organizational tree (org-tree) of the department |
| 4 | Main process | List of main SOPs that departments own or participate in |
| 5 | Departmental KPIs | KPI table: indicators, goals, measurements, frequency |
| 6 | Link SOP/WI/Form | Bang ma related documents |
...
| 2 | Fast time | List of components in the module |
| 3 | Content of divorce | Sections include information, state, and images |
| 4 | Because of the fact | Case study, practical situation at HESEM |
| 5 | Exercise quickly | Test questions, test instructions, and check questions |
| 6 | Checklist of famous people | Checklist for registered/unregistered students |
...
- Because the device MUST be in HESEM configuration (CNC machining, semiconductor parts, ISO 9001).
- The exercise MUST be done in the workplace with documents and current documents.
- Checklist of names to check when necessary, using the Dreyfus scale as reference.

---

## 7. State the total number of births

| Characteristic | SOP | WI | ANNEX | JD | Dept HB | Training |
|----------|-----|----|-------|----|---------| ---------|
| So section | 10 | 7 | Flexibility | 6 | 6 | 6 |
| Gate/checkpoint | Co | Are not | Are not | Are not | Are not | Co (checklist) |
| RACI | Co (Section 4) | Are not | Are not | Co (Section 3) | Are not | Are not |
| KPI | Co (Section 6) | Are not | Are not | Are not | Co (Section 5) | Are not |
| Step-by-step | Co (Section 7) | Co (Section 5) | Are not | Are not | Are not | Co (Section 5) |
| iso-map | Are not | Are not | Co | Are not | Are not | Are not |
| State data | Co | Co | MUST have | Co | Co | Co |
| Document link | Co (Section 10) | Co (Section 7) | Co | Co (Section 6) | Co (Section 6) | Are not |
