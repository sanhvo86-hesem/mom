# 18 — Form Online vs Form Offline (Excel) decision framework
...
| 4 | **Each form has only 1 original copy** | If online → web portal is original (PDF auto-gen). If offline → Excel is the original (uploaded again). There are NO 2 sources. |
...
| 2 | **Number of fields + complexity** | 20 | ≤15 fields: +20 · 16-25: +10 | 26-50: −5 · >50 / multi-tab: −20 | Count fields in form templates |
| 3 | **Place of filling** | 15 | Production floor / at the machine: +15 · QC department: +10 | Technical rooms: 0 · Meeting rooms: −5 | See who fills in (role) |
...
| 5 | **Approval workflow** | 10 | Multi-step e-signature: +10 · Manager notification: +5 | No workflow: 0 · Paper sign-off: −5 | Is there an escalation gate? |
...
| Filling place | 0 | Engineering office, desktop |
...
### 3.1 ALWAYS ONLINE (no rating required)

| Condition | Form example |
|-----------|-----------|
| Fill ≥2 times/day or per shift | FRM-504 (shift handover), FRM-208 (tier meeting) |
...
### 3.2 ALWAYS OFFLINE (no reviews needed)
...
| Condition |
|-----------|
| Weekly fill-in form (center) |
| The form has 15-25 fields |
| Form filled out at office but requires workflow |
| Newly created form, no usage history yet |
...
|------|-----|----------|-----------|-------|
| FRM-208 | Daily Tier Meeting Report | production. production | daily. daily | 80 |
| FRM-504 | Shift Handover Log | production. production | per_shift | 78 |
| FRM-512 | Machine Downtime Log | production. production | per_event | 90 |

### 4.2 ONLINE — Phase 2 (high priority, continue migrating)

| Form | Name | Category | Frequency | Score | Reason |
|------|-----|----------|-----------|-------|-------|
| FRM-631 | NCR Report | quality | per_event | 82 | Escalation gates, audit trails, KPIs |
...
| FRM-711 | Packing & Shipping Checklist | logistics. logistics | per_event | 70 | Ship release gate, real-time |
| FRM-715 | Certificate of Conformance | quality | per_event | 68 | Lot completion, approval |
| FRM-511 | Setup & First-Piece Record | production. production | per_event | 76 | Quick checklist, camera prove-out |
...
| FRM-403 | SCAR Report | logistics. logistics | per_event | 68 | Supplier corrective action workflow |
| FRM-601 | Calibration Record | quality | periodic | 65 | Equipment tracking, certificates |

### 4.3 ONLINE — Phase 3 (expanded further)

| Form | Name | Category | Frequency | Score |
|------|-----|----------|-----------|-------|
| FRM-501 | Planning Release Checklist | production. production | daily. daily | 72 |
| FRM-502 | Daily Dispatch List | production. production | daily. daily | 70 |
| FRM-505 | Machine Utilization Log | production. production | per_shift | 75 |
| FRM-507 | Job Progress Snapshot | production. production | per_event | 68 |
| FRM-513 | Tool Life & Wear Log | production. production | per_event | 70 |
| FRM-514 | SMED Quick Changeover | production. production | per_event | 66 |
| FRM-518 | Work Transfer Validation | production. production | per_event | 64 |
| FRM-519 | Job Packet Quick Check | production. production | per_event | 66 |
| FRM-721 | Customer ComplaintEnter | quality | per_event | 72 |
...
| Change management | FRM-141, 151, 161 | Office-based, detailed specifications |
...
- [ ] SharePoint List structure defined (metadata column)?
...
| Time-to-complete | ≤ 150% Excel time | >200% (form too complex for web) |
...
> **Applicable:** Any decision to create a new form or migrate a form from offline → online
