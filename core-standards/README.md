...
| `tools/context_translate_engine.py` | `tools/` | Công cụ dịch tự động Anh→Việt |
| `tools/qms-terminology-dictionary.xlsx` | `tools/` | Từ điển thuật ngữ QMS |
| `tools/remaining-english-words.xlsx` | `tools/` | Danh sách từ tiếng Anh cần dịch (5008 entries) |
