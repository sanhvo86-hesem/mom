...
6. Đọc thêm `16-sop-graphics-kpi-and-redraft-quality.md` trước khi tạo mới hoặc viết lại Section 6 / 7 để tránh lệch màu flowchart, KPI chung chung hoặc note biên tập lọt vào SOP
7. Dùng header chuẩn từ `general_note.md` mục 2
8. Ngôn ngữ nội dung: tiếng Việt, theo quy tắc `03-language-and-translation.md`
9. Section 3 phải viết tên thuật ngữ theo mẫu `English term (thuật ngữ tiếng Việt chuẩn)`
10. CSS reference: `../../../assets/style.css` (relative path)
11. Cuối body: `<script src="../../../assets/app.js"></script>`
