...
from specs_frm400 import FRM_400_CHECKLIST, FRM_400_LOG
import openpyxl
...
print("FRM-400 SERIES: 10 FORMS")
print("=" * 70)
success = failed = 0
for spec in FRM_400_CHECKLIST:
    code = spec['code']
    try:
...
print(f"\nFRM-400 COMPLETE: {success} OK, {failed} FAIL")
