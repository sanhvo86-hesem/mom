...
from specs_frm300 import FRM_300_CHECKLIST, FRM_300_REPORT, FRM_300_WIDE
...
print("=" * 70)
print("FRM-300 SERIES: 10 FORMS (Engineering core)")
print("=" * 70)
success = failed = 0
for spec in FRM_300_CHECKLIST + FRM_300_REPORT + FRM_300_WIDE:
    code = spec['code']
    try:
...
print(f"\nFRM-300 COMPLETE: {success} OK, {failed} FAIL")
