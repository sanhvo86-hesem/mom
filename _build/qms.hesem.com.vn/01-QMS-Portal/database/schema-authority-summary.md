...
**Migration range**: 001–091 (91 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–091_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE count: 672
