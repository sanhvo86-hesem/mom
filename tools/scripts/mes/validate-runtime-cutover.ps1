...
$dppEnergyCostMigrationFile = Join-Path $portalRoot "database\migrations\031_mes_dpp_energy_cost_foundations.sql"
...
foreach ($file in @($configFile, $dataLayerFile, $apiFile, $migrationFile, $notifyMigrationFile, $dppEnergyCostMigrationFile, $jsFile, $pollingServiceFile, $inboundWorkerFile, $transportAdapterFile, $outboxWorkerFile, $pollingCliFile, $runnerFile)) {
