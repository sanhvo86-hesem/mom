...
$wiringCommand = @"
rg -n 'page-mes|page-exceptions|14-mes-control-center|14-exception-dashboard|_renderMesControlCenter|_renderExceptionDashboard|navigateTo\(''exceptions''\)|data-page=\"mes\"|mes_snapshot|mes_connector_snapshot|mes_machine_signal_upsert|exception_dashboard|exception_detail|program_mismatches|program_handshake_queue|oee_timeline|downtime_pareto|mes_wo_report_progress|mes_downtime_create|mes_maintenance_create|mes_tooling_upsert|data-open-signal-bridge' "$($wiringFiles -join '" "')"
"@
