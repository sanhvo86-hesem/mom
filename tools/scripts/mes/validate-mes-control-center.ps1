...
$schemaCommand = @"
rg -n 'mes_connectivity_adapters|mes_connectivity_events|mes_alarm_catalog|mes_alarm_playbooks|mes_nc_release_packages|mes_nc_download_receipts|mes_tool_preset_offsets|mes_tool_assemblies|mes_erp_sync_runs|mes_erp_reconciliation_exceptions|integration_system|sync_direction|sync_status|completed_at|records_received|records_processed|exception_status|expected_value|actual_value|is_acknowledged|acknowledged_at|related_job_number|v_mes_adapter_health|v_mes_nc_release_readiness' "$($schemaFiles -join '" "')"
"@
