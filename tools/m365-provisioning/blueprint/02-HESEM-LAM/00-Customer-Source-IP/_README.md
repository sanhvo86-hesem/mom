...
Source: customer (LAM). Authoring authority: customer. HESEM custody only.

NO 3-state lifecycle here. Customer artifacts arrive pre-released from LAM
...
Sub-zones:
  ...
  03-Specifications     — customer-controlled specs (LAM-PCC-internal + Ra<=0.4um chamber + ASTM-E595)
  04-ECN-Inbound        — engineering change notices received
  05-Customer-SQM-NDA-Vault — supplier quality manual (NDA-gated)

Permission: SG-CUSTOMER-LAM Read; Edit denied tenant-wide (Power Automate enforces).
