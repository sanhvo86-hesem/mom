# 30-SCAR-8D — Supplier Corrective Action Request (8D format)
...
Submitted via SupplierNet-SupplierIdentities. Effectiveness verification by ASML closes the case.
