# SITE — HESEM-AMAT customer spoke

Purview Information Barrier mode: **Explicit**.
IB segment: `SG-CUSTOMER-AMAT` (Entra attribute or group-MemberOf).
Sensitivity label default: **Customer:AMAT-Confidential** (encrypted; SG-CUSTOMER-AMAT only).

Portal channel: **AMAT-Ariba-SecureTransfer**
Cleanliness regime: **AMAT-0250-xxxxx + IEST-STD-CC1246**
FAI template: **AS9102-equiv (AMAT-templated Form-1/2/3)**
...
10 zones (top level under this site):
  ...
  80-Portal-Exports              — docs exported from AMAT-Ariba-SecureTransfer
