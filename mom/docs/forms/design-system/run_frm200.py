...
from specs_frm200 import FRM_200_CHECKLIST, FRM_200_LOG, FRM_200_TRACKER
import openpyxl
...
print("=" * 70)
print("FRM-200 SERIES: 13 FORMS")
print("=" * 70)
success = failed = 0

for spec in FRM_200_CHECKLIST + FRM_200_TRACKER:
    code = spec['code']
    try:
...
print(f"\nFRM-200 COMPLETE: {success} OK, {failed} FAIL")
