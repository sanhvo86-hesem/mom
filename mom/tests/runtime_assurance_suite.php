...
use MOM\Services\ApprovalWorkflowAdapter;
...
$engineSrc = file_get_contents((new ReflectionClass(\MOM\Services\WorkflowEngine::class))->getFileName());
...
$auditSrc = file_get_contents((new ReflectionClass(\MOM\Services\AuditTrail::class))->getFileName());
...
$fcPath = $baseDir . '/data/registry/frontend-foundation-catalog.json';
