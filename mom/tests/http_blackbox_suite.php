...
$fc = json_decode(file_get_contents($baseDir . '/data/registry/frontend-foundation-catalog.json'), true);
$dp = json_decode(file_get_contents($baseDir . '/data/registry/domain-field-packs.json'), true);
