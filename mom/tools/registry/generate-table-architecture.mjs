...
const migrationDomainDefaults = new Map([
  ...
  ['136_eqms_worldclass_surface.sql', 'quality_management'],
  ['137_eqms_schema_drift_reconcile.sql', 'quality_management'],
  ['138_eqms_performance_indexes.sql', 'quality_management'],
  ['139_eqms_runtime_contract_reconcile.sql', 'quality_management'],
  ['140_migrate_ncr_capa_to_eqms.sql', 'quality_management'],
  ['141_extend_eqms_documents_migrate_records.sql', 'document_control'],
  ['142_eqms_supplier_iqc_aggregates.sql', 'quality_management'],
  ['143_eqms_mdm_reference_codes.sql', 'master_data'],
  ['144_eqms_master_reference_alignment.sql', 'master_data'],
  ['145_eqms_sprint6a_concessions_fai_sc.sql', 'quality_management'],
  ['146_eqms_sprint6b_aml_warranty.sql', 'quality_management'],
  ['147_eqms_sprint6c_lessons_csat_sampling.sql', 'quality_management'],
  ['148_graphics_authority_tables.sql', 'system_infrastructure'],
  ['149_graphics_v4_governance_tables.sql', 'system_infrastructure'],
  ['150_dcc_document_change_control.sql', 'document_control'],
  ['151_dcc_header_graphics_tokens.sql', 'document_control'],
  ['152_dcc_document_locale_variants.sql', 'document_control'],
  ['153_dcc_consolidation_sequence_reservation.sql', 'document_control'],
  ['154_dcc_consolidation_sequence_reservation.sql', 'document_control'],
  ['155_dcc_consolidation.sql', 'document_control'],
  ['156_live_schema_drift_governance_reconcile.sql', 'system_infrastructure'],
  ['157_translation_admin_module.sql', 'core_system'],
  ['158_translation_admin_fix_model_catalogue.sql', 'core_system'],
  ['159_rbac_permission_catalog.sql', 'core_system'],
  ['160_rbac_modules_and_module_permission.sql', 'core_system'],
  ['161_rbac_document_permission_grant.sql', 'core_system'],
  ['162_rbac_role_sod_conflict.sql', 'core_system'],
  ['163_rbac_role_badge_tokens.sql', 'core_system'],
  ['164_rbac_access_review.sql', 'core_system'],
  ['165_rbac_mfa_factors_and_policy.sql', 'core_system'],
  ['166_content_effective_documents_and_acknowledgement.sql', 'document_control'],
  ['167_content_portal_display.sql', 'core_system'],
  ['168_content_retention_policy.sql', 'core_system'],
  ['169_diacritics_repair.sql', 'core_system'],
  ['170_diacritics_repair_permission_catalog.sql', 'core_system'],
