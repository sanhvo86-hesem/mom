...
-- pgvector not available in local benchmark runtime
...
-- <<< END MIGRATION: 001_extensions_and_types.sql

-- >>> BEGIN MIGRATION: 002_core_system.sql
...
-- <<< END MIGRATION: 002_core_system.sql

-- >>> BEGIN MIGRATION: 003_document_management.sql
...
-- <<< END MIGRATION: 003_document_management.sql

-- >>> BEGIN MIGRATION: 004_form_system.sql
...
-- <<< END MIGRATION: 004_form_system.sql

-- >>> BEGIN MIGRATION: 005_record_management.sql
...
-- <<< END MIGRATION: 005_record_management.sql

-- >>> BEGIN MIGRATION: 006_erp_master_data.sql
...
-- <<< END MIGRATION: 006_erp_master_data.sql

-- >>> BEGIN MIGRATION: 007_customers_sales.sql
...
-- <<< END MIGRATION: 007_customers_sales.sql

-- >>> BEGIN MIGRATION: 008_vendors_purchasing.sql
...
-- <<< END MIGRATION: 008_vendors_purchasing.sql

-- >>> BEGIN MIGRATION: 009_inventory.sql
...
-- <<< END MIGRATION: 009_inventory.sql

-- >>> BEGIN MIGRATION: 010_production.sql
...
-- <<< END MIGRATION: 010_production.sql

-- >>> BEGIN MIGRATION: 011_quality.sql
...
-- <<< END MIGRATION: 011_quality.sql

-- >>> BEGIN MIGRATION: 012_calibration_equipment.sql
...
-- <<< END MIGRATION: 012_calibration_equipment.sql

-- >>> BEGIN MIGRATION: 013_training_hr.sql
...
-- <<< END MIGRATION: 013_training_hr.sql

-- >>> BEGIN MIGRATION: 014_audit_risk.sql
...
-- <<< END MIGRATION: 014_audit_risk.sql

-- >>> BEGIN MIGRATION: 015_finance.sql
...
-- <<< END MIGRATION: 015_finance.sql

-- >>> BEGIN MIGRATION: 016_shipping_compliance.sql
...
-- <<< END MIGRATION: 016_shipping_compliance.sql

-- >>> BEGIN MIGRATION: 017_subcontracting_rma.sql
...
-- <<< END MIGRATION: 017_subcontracting_rma.sql

-- >>> BEGIN MIGRATION: 018_projects_kpi.sql
...
-- <<< END MIGRATION: 018_projects_kpi.sql

-- >>> BEGIN MIGRATION: 019_system_tables.sql
...
-- <<< END MIGRATION: 019_system_tables.sql

-- >>> BEGIN MIGRATION: 020_indexes.sql
...
-- vector benchmark index skipped in local runtime
...
-- <<< END MIGRATION: 020_indexes.sql

-- >>> BEGIN MIGRATION: 021_views.sql
...
-- <<< END MIGRATION: 021_views.sql

-- >>> BEGIN MIGRATION: 022_functions_triggers.sql
...
-- <<< END MIGRATION: 022_functions_triggers.sql

-- >>> BEGIN MIGRATION: 023_rls_policies.sql
...
-- <<< END MIGRATION: 023_rls_policies.sql

-- >>> BEGIN MIGRATION: 024_seed_data.sql
...
-- <<< END MIGRATION: 024_seed_data.sql

-- >>> BEGIN MIGRATION: 025_mes_tables.sql
-- ============================================================================
...
--
-- COMMIT;
-- <<< END MIGRATION: 025_mes_tables.sql

-- >>> BEGIN MIGRATION: 026_mes_world_class_foundations.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 026_mes_world_class_foundations.sql

-- >>> BEGIN MIGRATION: 027_mes_alarm_governance_alignment.sql
-- ============================================================================
...
-- <<< END MIGRATION: 027_mes_alarm_governance_alignment.sql

-- >>> BEGIN MIGRATION: 028_epicor_mes_integration_foundations.sql
-- ============================================================================
...
-- <<< END MIGRATION: 028_epicor_mes_integration_foundations.sql

-- >>> BEGIN MIGRATION: 029_mes_timescale_runtime_activation.sql
-- ============================================================================
...
BEGIN
  ...
  END;
END $$;
-- <<< END MIGRATION: 029_mes_timescale_runtime_activation.sql

-- >>> BEGIN MIGRATION: 030_mes_realtime_notify.sql
...
BEGIN
    ...
    END IF;
END $$;
-- <<< END MIGRATION: 030_mes_realtime_notify.sql

-- >>> BEGIN MIGRATION: 031_mes_dpp_energy_cost_foundations.sql
-- ============================================================================
-- Migration 031
...
-- <<< END MIGRATION: 031_mes_dpp_energy_cost_foundations.sql

-- >>> BEGIN MIGRATION: 032_order_management_world_class_foundations.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 032_order_management_world_class_foundations.sql

-- >>> BEGIN MIGRATION: 033_order_management_extended.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 033_order_management_extended.sql

-- >>> BEGIN MIGRATION: 034_exception_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 034_exception_management.sql

-- >>> BEGIN MIGRATION: 035_supplier_quality_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 035_supplier_quality_management.sql

-- >>> BEGIN MIGRATION: 036_quoting_estimation.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 036_quoting_estimation.sql

-- >>> BEGIN MIGRATION: 037_evidence_vault.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 037_evidence_vault.sql

-- >>> BEGIN MIGRATION: 038_customer_portal.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 038_customer_portal.sql

-- >>> BEGIN MIGRATION: 039_cnc_program_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 039_cnc_program_management.sql

-- >>> BEGIN MIGRATION: 040_digital_product_passport.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 040_digital_product_passport.sql

-- >>> BEGIN MIGRATION: 041_ai_predictive_quality_aps.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 041_ai_predictive_quality_aps.sql

-- >>> BEGIN MIGRATION: 042_fmea_apqp_control_plan_mobile.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 042_fmea_apqp_control_plan_mobile.sql

-- >>> BEGIN MIGRATION: 043_production_dispatch_shift_targets.sql
...
-- <<< END MIGRATION: 043_production_dispatch_shift_targets.sql

-- >>> BEGIN MIGRATION: 044_shift_calendar.sql
...
COMMIT;
-- <<< END MIGRATION: 044_shift_calendar.sql

-- >>> BEGIN MIGRATION: 045_oqc_packing_outsource.sql
...
COMMIT;
-- <<< END MIGRATION: 045_oqc_packing_outsource.sql

-- >>> BEGIN MIGRATION: 046_plant_maintenance_cmms.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 046_plant_maintenance_cmms.sql

-- >>> BEGIN MIGRATION: 047_advanced_planning_scheduling.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 047_advanced_planning_scheduling.sql

-- >>> BEGIN MIGRATION: 048_plm_change_control.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 048_plm_change_control.sql

-- >>> BEGIN MIGRATION: 049_hcm_workforce_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 049_hcm_workforce_management.sql

-- >>> BEGIN MIGRATION: 050_wms_extended_warehouse.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 050_wms_extended_warehouse.sql

-- >>> BEGIN MIGRATION: 051_finance_trade_multicurrency.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 051_finance_trade_multicurrency.sql

-- >>> BEGIN MIGRATION: 052_project_system_earned_value.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 052_project_system_earned_value.sql

-- >>> BEGIN MIGRATION: 053_crm_pipeline_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 053_crm_pipeline_management.sql

-- >>> BEGIN MIGRATION: 054_transportation_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 054_transportation_management.sql

-- >>> BEGIN MIGRATION: 055_bi_data_warehouse.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 055_bi_data_warehouse.sql

-- >>> BEGIN MIGRATION: 056_supplier_relationship_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 056_supplier_relationship_management.sql

-- >>> BEGIN MIGRATION: 057_tooling_lifecycle_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 057_tooling_lifecycle_management.sql

-- >>> BEGIN MIGRATION: 058_sop_demand_supply_planning.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 058_sop_demand_supply_planning.sql

-- >>> BEGIN MIGRATION: 059_service_warranty_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 059_service_warranty_management.sql

-- >>> BEGIN MIGRATION: 060_finance_treasury_assets.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 060_finance_treasury_assets.sql

-- >>> BEGIN MIGRATION: 061_quality_lab_compliance.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 061_quality_lab_compliance.sql

-- >>> BEGIN MIGRATION: 062_ehs_sustainability_management.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 062_ehs_sustainability_management.sql

-- >>> BEGIN MIGRATION: 063_manufacturing_engineering_industrialization.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 063_manufacturing_engineering_industrialization.sql

-- >>> BEGIN MIGRATION: 064_master_data_governance.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 064_master_data_governance.sql

-- >>> BEGIN MIGRATION: 065_commercial_contract_pricing.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 065_commercial_contract_pricing.sql

-- >>> BEGIN MIGRATION: 066_traceability_serialization.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 066_traceability_serialization.sql

-- >>> BEGIN MIGRATION: 067_outsource_supplier_execution.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 067_outsource_supplier_execution.sql

-- >>> BEGIN MIGRATION: 068_trade_compliance_advanced.sql
-- ============================================================================
...
COMMIT;
-- <<< END MIGRATION: 068_trade_compliance_advanced.sql
