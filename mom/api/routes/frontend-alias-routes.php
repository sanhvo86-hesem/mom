...
return static function (Router $router, string $dataDir): void {
    ...
    $router->actions([
        ...
        'eqms_suppliers_comments' => [EqmsSuppliersController::class, 'comments'],
        'eqms_suppliers_attachments' => [EqmsSuppliersController::class, 'attachments'],
        'eqms_suppliers_relationships' => [EqmsSuppliersController::class, 'relationships'],
        'eqms_suppliers_scorecards' => [EqmsSuppliersController::class, 'scorecards'],
        'eqms_suppliers_qualifications' => [EqmsSuppliersController::class, 'qualifications'],
        'eqms_suppliers_quality_agreements' => [EqmsSuppliersController::class, 'qualityAgreements'],
        'eqms_suppliers_deviations' => [EqmsSuppliersController::class, 'deviations'],
        'eqms_suppliers_scars' => [EqmsSuppliersController::class, 'scars'],
    ...
    $router->actions([
        ...
        'eqms_supplier_audits_audit'   => [EqmsSupplierAuditsController::class, 'audit'],
        'eqms_supplier_audits_comments' => [EqmsSupplierAuditsController::class, 'comments'],
        'eqms_supplier_audits_attachments' => [EqmsSupplierAuditsController::class, 'attachments'],
        'eqms_supplier_audits_export'  => [EqmsSupplierAuditsController::class, 'export'],
        ...
        'eqms_scars_metrics'                         => [EqmsSupplierAuditsController::class, 'scarMetrics'],
        'eqms_scars_audit'                           => [EqmsSupplierAuditsController::class, 'scarAudit'],
        'eqms_scars_signatures'                      => [EqmsSupplierAuditsController::class, 'scarSignatures'],
        'eqms_scars_comments'                        => [EqmsSupplierAuditsController::class, 'scarComments'],
        'eqms_scars_attachments'                     => [EqmsSupplierAuditsController::class, 'scarAttachments'],
        'eqms_scars_export'                          => [EqmsSupplierAuditsController::class, 'scarExport'],
    ...
    $router->actions([
        ...
        'eqms_quality_agreements_detail'     => [EqmsSuppliersController::class, 'qualityAgreementDetail'],
        'eqms_quality_agreements_create'     => [EqmsSuppliersController::class, 'qualityAgreementCreateStandalone'],
        'eqms_quality_agreements_update'     => [EqmsSuppliersController::class, 'qualityAgreementUpdate'],
        'eqms_quality_agreements_metrics'    => [EqmsSuppliersController::class, 'qualityAgreementMetrics'],
        'eqms_quality_agreements_audit'      => [EqmsSuppliersController::class, 'qualityAgreementAudit'],
        'eqms_quality_agreements_signatures' => [EqmsSuppliersController::class, 'qualityAgreementSignatures'],
        'eqms_quality_agreements_comments'   => [EqmsSuppliersController::class, 'qualityAgreementComments'],
        'eqms_quality_agreements_attachments' => [EqmsSuppliersController::class, 'qualityAgreementAttachments'],
        'eqms_quality_agreements_relationships' => [EqmsSuppliersController::class, 'qualityAgreementRelationships'],
