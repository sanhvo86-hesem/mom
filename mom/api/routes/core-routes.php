...
return static function (Router $router, string $dataDir): void {
    ...
    $router->actions([
        ...
        'admin_gha_settings_get'           => [AdminController::class, 'ghaSettingsGet'],
        'admin_gha_settings_set'           => [AdminController::class, 'ghaSettingsSet'],
        'admin_gha_settings_delete'        => [AdminController::class, 'ghaSettingsDelete'],
