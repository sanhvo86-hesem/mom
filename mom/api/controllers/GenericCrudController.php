...
class GenericCrudController extends BaseController
{
    ...
    private const DOMAIN_COMMAND_REQUIRED_TABLES = [
        ...
        'inventory_ledger',
        'inventory_ledger_command_packet',
        'inventory_ledger_posting_packet',
        'inventory_balance_snapshot',
        'inventory_reconciliation_run',
        'inventory_reconciliation_discrepancy',
        'inventory_period_close_gate',
        'inventory_recall_evidence_export',
        ...
        'party_site',
        'party_contact',
        'party_profile_extension',
        'user_party_link',
        'party_merge_remap_catalog',
        'customer_item_approval_authority',
        'supplier_process_approval_authority',
        'customers',
        'customer_sites',
        'suppliers',
        'vendors',
        ...
        'item_revisions',
        'item_site',
        'item_site_profile_authority',
        'item_spec',
        'item_legacy_key_bridge',
        'item_customer_crossref_authority',
        'item_supplier_crossref_authority',
        'bom',
        'bill_of_materials',
        'bom_version',
        'bom_line',
        ...
        'work_order_engineering_package_snapshot',
        'inspection_lot',
        'inspection_result',
        ...
        'mda_security_boundary_policy',
        'mda_field_redaction_policy',
        'mda_sod_exception_authority',
        'mda_ai_action_firewall_event',
        'mda_ot_signal_trust_policy',
        'mda_security_boundary_decision',
        'mda_authoritative_record_shell_anchor',
        'mda_workspace_projection_policy',
        'mda_workspace_projection_freshness',
        'mda_frontend_alias_resolution_policy',
        'mda_offline_candidate_queue',
        'mda_frontend_action_guard_decision',
        'mes_runtime_event_spine',
