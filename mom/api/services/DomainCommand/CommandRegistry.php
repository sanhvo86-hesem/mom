...
final class CommandRegistry
{
    ...
    private const COMMANDS = [
        ...
        'ReceiveInventoryCommand' => [
            ...
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:receive',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryReceived'],
            'implemented' => true,
        ],
        'PutawayInventoryCommand' => [
            'root' => 'inventory_ledger',
            'permission' => 'inventory.putaway',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:putaway',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryPutaway'],
            'implemented' => true,
        ],
        'MoveInventoryCommand' => [
            ...
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:move',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryMoved'],
            'implemented' => true,
        ],
        'SplitLotCommand' => [
            'root' => 'inventory_ledger',
            'permission' => 'inventory.lot.split',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:lot:split',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryLotSplit'],
            'implemented' => true,
        ],
        'MergeLotCommand' => [
            'root' => 'inventory_ledger',
            'permission' => 'inventory.lot.merge',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:lot:merge',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryLotMerged'],
            'implemented' => true,
        ],
        'CompleteToStockCommand' => [
            'root' => 'inventory_ledger',
            'permission' => 'inventory.complete_to_stock',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:complete_to_stock',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryCompletedToStock'],
            'implemented' => true,
        ],
        'ScrapInventoryCommand' => [
            'root' => 'inventory_ledger',
            'permission' => 'inventory.scrap',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:scrap',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryScrapped'],
            'implemented' => true,
        ],
        'ReworkInventoryCommand' => [
            'root' => 'inventory_ledger',
            'permission' => 'inventory.rework',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:rework',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryReworked'],
            'implemented' => true,
        ],
        'AdjustInventoryWithApprovalCommand' => [
            ...
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:adjustment',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryAdjusted'],
            'implemented' => true,
        ],
        'CloseInventoryPeriodCommand' => [
            'root' => 'inventory_period_close',
            'permission' => 'inventory.period.close',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:period_close',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryPeriodClosed'],
            'implemented' => true,
        ],
        'RunInventoryReconciliationCommand' => [
            'root' => 'inventory_reconciliation',
            'permission' => 'inventory.reconcile',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:reconciliation',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['InventoryReconciled'],
            'implemented' => true,
        ],
        'ExportRecallTraceCommand' => [
            'root' => 'inventory_recall_trace',
            'permission' => 'inventory.recall_trace.export',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:recall_trace',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['RecallTraceExported'],
            'implemented' => true,
        ],
        'CostRollupCommand' => [
            'root' => 'cost_ledger',
            'permission' => 'finance.cost.rollup',
            'regulated_action' => true,
            'idempotency_scope' => 'finance:cost_rollup',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['CostRollupPosted'],
            'implemented' => true,
        ],
        'ShipmentPackCommand' => [
            'root' => 'shipment_packages',
            'permission' => 'inventory.shipment.pack',
            'regulated_action' => true,
            'idempotency_scope' => 'inventory:shipment_pack',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['ShipmentPackagePacked'],
            'implemented' => true,
        ],
        'ReportToolBreakageCommand' => [
            'root' => 'tooling_breakage',
            'permission' => 'tooling.breakage.report',
            'regulated_action' => true,
            'idempotency_scope' => 'tooling:breakage',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['ToolBreakageReported', 'QualityHoldApplied'],
            'implemented' => true,
        ],
        'GageOOTInvestigationCommand' => [
            'root' => 'gage_oot_investigation',
            'permission' => 'quality.gage_oot.investigate',
            'regulated_action' => true,
            'idempotency_scope' => 'quality:gage_oot',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['GageOOTInvestigationRecorded', 'QualityHoldApplied'],
            'implemented' => true,
        ],
        'ToolPresetMeasurementCommand' => [
            'root' => 'tooling_presets',
            'permission' => 'tooling.preset.measure',
            'regulated_action' => true,
            'idempotency_scope' => 'tooling:preset_measurement',
            'openapi_operation' => 'submitDomainCommand',
            'expected_events' => ['ToolPresetMeasurementRecorded'],
            'implemented' => true,
        ],
