    ...
    private function defaultItems(): array
    {
        return [
            ...
            [
                ...
                'escalation' => 'ECO phát sinh khi lệnh đang chạy G3+ → ENGM + QA + PPL Sau ECO ảnh hưởng form / fit / function, đổi nguồn vật tư, đổi vị trí gia công, hoặc nghỉ sản xuất chi tiết đó ≥ 24 tháng → bắt buộc re-FAI theo AS9102 §5.4; mở CDR D1 song song.',
                'cdrs' => ['B3'],
            ],
            [
            ...
            [
                ...
                'escalation' => 'Mua khẩn ngoài kế hoạch, giá vượt chuẩn, nguồn đơn hoặc rủi ro giao hàng khách → CEO. Nhà cung cấp chưa qualify + mua khẩn → CEO + QA cùng ký, ghi rủi ro vào FRM-406; bắt buộc qualify trong 30 ngày làm việc nếu tiếp tục dùng.',
                'cdrs' => ['E5'],
            ],
            [
                'key' => 'scar_escalation',
            ...
            [
                ...
                'escalation' => 'Quyền vượt thẩm quyền kinh doanh hoặc xung đột phân tách nhiệm vụ → ESA + CEO Có dấu hiệu xâm nhập, rò rỉ dữ liệu khách hoặc thay đổi dữ liệu bất thường → ITA + ESA + CEO leo thang ngay, cô lập hệ thống trước khi xử lý; thông báo khách hàng theo CDR D11 nếu dữ liệu khách bị ảnh hưởng.',
                'cdrs' => ['F1'],
            ],
            [
                'key' => 'erp_breakglass',
