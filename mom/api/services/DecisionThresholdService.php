    ...
    private function defaultItems(): array
    {
        return [
            ...
            [
                ...
                'l2' => 'QA + PD duyệt khi ảnh hưởng giao hàng nhưng chưa chạm CTQ trọng yếu hoặc lot ≤ 50 chi tiết.',
                'l3' => 'ENGM + QA + PD duyệt lưu hoặc khôi phục chương trình tác động ≤ 1 lô đang sản xuất.',
                'r' => 'ENGM',
                'evidence' => 'FRM-413 · SOP-606',
                'escalation' => 'Khi vượt L2, ảnh hưởng yêu cầu hợp đồng hoặc khách yêu cầu trả lại bản gốc → leo thang CEO + khách ký.',
                'cdrs' => ['B7'],
            ],
            [
            ...
            [
                ...
                'l2' => 'PD duyệt phục hồi tác động ≤ 3 ngày giao hàng với phương án OT hoặc ưu tiên máy thay thế.',
                'l3' => 'PD duyệt phục hồi tác động ≤ 5 ngày giao hàng với kế hoạch nguồn lực rõ ràng (OT, gia công ngoài, hoán đổi máy).',
                'r' => 'PD',
                'evidence' => 'FRM-512 · FRM-522 · SOP-201',
                'escalation' => 'Khi tác động > 5 ngày, cần đổi cam kết khách hoặc liên quan crash máy thiệt hại > 500 triệu VND → leo thang CEO + CS.',
                'cdrs' => ['C7'],
            ],
            [
                'key' => 'fai_release',
            ...
            [
                ...
                'l2' => 'QA dỡ hold khi lot đã sẵn sàng giao, NCR đã đóng và không còn rủi ro mở.',
                'l3' => 'QA + PD đồng ký giữ hoặc dỡ CoC hold khi không có yếu tố khách hoặc pháp lý chưa rõ.',
                'r' => 'QA',
                'evidence' => 'FRM-413 · kết quả kiểm cuối · phản hồi khách hàng nếu có',
                'escalation' => 'Khi có áp lực giao hàng, khiếu nại đang mở, rủi ro danh tiếng hoặc đe dọa pháp lý → leo thang CEO + QA.',
                'cdrs' => ['D7'],
            ],
            [
                'key' => 'coc_release',
