...
(function(win){
  ...
  function ensureStyles(){
    ...
    style.textContent = [
      ...
      '.ams-r6-kicker{font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--cyan-300, #7dd3fc);font-weight:800;position:relative;z-index:1;}',
      '.ams-r6-title{margin:8px 0 10px;font-size:26px;line-height:1.1;color:var(--white, #fff);position:relative;z-index:1;}',
      '.ams-r6-sub{font-size:12px;line-height:1.55;color:var(--border-light, #cbd5e1);position:relative;z-index:1;}',
      ...
      '.ams-r6-badge{display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border-radius:999px;background:rgba(255,255,255,.06);border:1px solid rgba(148,163,184,.12);font-size:11px;font-weight:700;color:var(--brand-9, #dbeafe);}',
      '.ams-r6-badge.tone-good{border-color:rgba(34,197,94,.28);background:rgba(34,197,94,.10);color:var(--green-100, #dcfce7);}',
      '.ams-r6-badge.tone-warning{border-color:rgba(245,158,11,.28);background:rgba(245,158,11,.10);color:var(--amber-100, #fef3c7);}',
      '.ams-r6-badge.tone-critical{border-color:rgba(239,68,68,.28);background:rgba(239,68,68,.10);color:var(--red-100, #fee2e2);}',
      ...
      '.ams-r6-card h4{margin:0 0 8px;font-size:15px;color:var(--white, #fff);}',
      ...
      '.ams-r6-metric strong{display:block;font-size:24px;color:var(--white, #fff);line-height:1;margin-top:6px;}',
...
(function(win){
  ...
  function ensureStyles(){
    ...
    style.textContent = [
      ...
      '.ams-r7-hero,.ams-r7-card{border:1px solid rgba(117,139,255,.16);background:linear-gradient(180deg,rgba(13,20,36,.96),rgba(12,21,42,.9));box-shadow:0 18px 42px rgba(3,9,24,.28);border-radius:24px;padding:18px;color:var(--blue-50, #eaf2ff);}',
      '.ams-r7-title{font-size:24px;font-weight:800;line-height:1.2;}',
      '.ams-r7-sub{color:var(--slate-blue, #93a3c7);font-size:12px;letter-spacing:.01em;line-height:1.45;}',
      '.ams-r7-kicker{color:var(--slate-blue, #93a3c7);font-size:12px;text-transform:uppercase;letter-spacing:.08em;}',
      ...
      '.ams-r7-badge,.ams-r7-chip{display:inline-flex;align-items:center;gap:6px;padding:7px 10px;border-radius:999px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.06);font-size:12px;font-weight:700;color:var(--white-blue, #f5f8ff);}',
      ...
      '.ams-r7-chip{font-weight:600;color:var(--blue-200, #d9e4ff);background:rgba(60,86,155,.16);}',
...
(function(win){
  ...
  function ensureStyles(){
    ...
    style.textContent = [
      ...
      '.ams-r9-hero,.ams-r9-card{border:1px solid rgba(125,211,252,.16);background:linear-gradient(180deg,rgba(8,16,30,.96),rgba(10,21,42,.90));box-shadow:0 20px 48px rgba(2,6,23,.30);border-radius:24px;padding:18px;color:var(--blue-50, #eaf2ff);}',
      '.ams-r9-kicker{color:var(--cyan-300, #7dd3fc);font-size:11px;text-transform:uppercase;letter-spacing:.12em;font-weight:800;}',
      '.ams-r9-title{font-size:24px;font-weight:800;line-height:1.18;color:var(--white-blue, #f8fbff);margin-top:4px;}',
      '.ams-r9-sub{color:var(--slate-blue, #93a3c7);font-size:12px;line-height:1.5;letter-spacing:.01em;}',
      ...
      '.ams-r9-badge,.ams-r9-chip{display:inline-flex;align-items:center;gap:6px;padding:7px 10px;border-radius:999px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.06);font-size:12px;font-weight:700;color:var(--white-blue, #f5f8ff);}',
      ...
      '.ams-r9-chip{font-weight:600;color:var(--brand-9, #dbeafe);background:rgba(59,130,246,.14);}',
      ...
      '.ams-r9-metric strong{font-size:28px;line-height:1;color:var(--white-blue, #f8fbff);}',
      ...
      '.ams-r9-item strong{color:var(--white-blue, #f8fbff);}',
...
(function(win){
  ...
  function ensureStyles(){
    ...
    style.textContent = [
      ...
      '.ams-r10-hero,.ams-r10-card{border:1px solid rgba(125,211,252,.16);background:linear-gradient(180deg,rgba(7,14,28,.97),rgba(10,18,34,.92));box-shadow:0 20px 48px rgba(2,6,23,.30);border-radius:24px;padding:18px;color:var(--blue-50, #eaf2ff);}',
      '.ams-r10-kicker{color:var(--cyan-300, #7dd3fc);font-size:11px;text-transform:uppercase;letter-spacing:.12em;font-weight:800;}',
      '.ams-r10-title{font-size:24px;font-weight:800;line-height:1.18;color:var(--white-blue, #f8fbff);margin-top:4px;}',
      '.ams-r10-sub{color:var(--slate-blue, #93a3c7);font-size:12px;line-height:1.55;letter-spacing:.01em;}',
      ...
      '.ams-r10-badge,.ams-r10-chip{display:inline-flex;align-items:center;gap:6px;padding:7px 10px;border-radius:999px;border:1px solid rgba(255,255,255,.08);background:rgba(255,255,255,.06);font-size:12px;font-weight:700;color:var(--white-blue, #f5f8ff);}',
      ...
      '.ams-r10-chip{font-weight:600;color:var(--brand-9, #dbeafe);background:rgba(59,130,246,.14);}',
      ...
      '.ams-r10-metric strong{font-size:28px;line-height:1;color:var(--white-blue, #f8fbff);}',
      ...
      '.ams-r10-item strong{color:var(--white-blue, #f8fbff);}',
...
(function(win){
  ...
  function ensureStyles(){
    ...
    style.textContent = [
      ...
      '.ams-r11-kicker{font-size:10px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--slate-blue, #8fa5c7);}',
      '.ams-r11-title{font-size:20px;font-weight:800;color:var(--white-blue, #f8fbff);margin-top:5px;}',
      '.ams-r11-sub{font-size:12px;line-height:1.55;color:var(--slate-blue, #93a5c4);margin-top:7px;}',
      '.ams-r11-badges{display:flex;flex-wrap:wrap;gap:8px;}',
      '.ams-r11-badge{display:inline-flex;align-items:center;gap:6px;height:24px;padding:0 10px;border-radius:999px;border:1px solid rgba(148,163,184,.12);background:rgba(255,255,255,.05);font-size:10px;font-weight:800;color:var(--white-blue, #f8fbff);}',
      ...
      '.ams-r11-card h4{margin:0;color:var(--white-blue, #f8fbff);font-size:15px;}',
      ...
      '.ams-r11-metric span{font-size:10px;font-weight:800;color:var(--slate-blue, #8fa5c7);text-transform:uppercase;letter-spacing:.04em;}',
      '.ams-r11-metric strong{font-size:20px;font-weight:800;color:var(--white-blue, #f8fbff);}',
      '.ams-r11-metric em{font-style:normal;font-size:11px;line-height:1.4;color:var(--slate-blue, #93a5c4);}',
...
(function(win){
  ...
  function ensureStyles(){
    ...
    style.textContent = [
      ...
      '.ams-r12-kicker{font-size:10px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--slate-blue, #8fa5c7);}',
      '.ams-r12-title{font-size:20px;font-weight:800;color:var(--white-blue, #f8fbff);margin-top:5px;}',
      '.ams-r12-sub{font-size:12px;line-height:1.55;color:var(--slate-blue, #93a5c4);margin-top:7px;}',
      ...
      '.ams-r12-metric span{font-size:10px;font-weight:800;color:var(--slate-blue, #8fa5c7);text-transform:uppercase;letter-spacing:.04em;}',
      '.ams-r12-metric strong{font-size:20px;font-weight:800;color:var(--white-blue, #f8fbff);}',
      '.ams-r12-metric em{font-style:normal;font-size:11px;color:var(--slate-blue, #93a5c4);line-height:1.45;}',
      ...
      '.ams-r12-card h4{margin:0;color:var(--white-blue, #f8fbff);font-size:15px;}',
      ...
      '.ams-r12-pill{display:inline-flex;align-items:center;gap:6px;height:24px;padding:0 10px;border-radius:999px;border:1px solid rgba(148,163,184,.12);background:rgba(255,255,255,.05);font-size:10px;font-weight:800;color:var(--white-blue, #f8fbff);}',
