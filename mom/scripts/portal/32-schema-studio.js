...
(function(){
  ...
  function ensureEnterpriseStyles(){
    ...
    styleEl.textContent = [
      ...
      '.ss-enterprise-dialog{width:min(1200px,96vw);max-height:92vh;overflow:hidden;background:var(--white, #fff);border:1px solid rgba(15,23,42,.14);border-radius:18px;box-shadow:0 22px 68px rgba(15,23,42,.22);display:flex;flex-direction:column;}',
      ...
      '.ss-enterprise-head h3{margin:2px 0 0;font-size:20px;color:var(--text-primary, #0f172a);}',
      '.ss-enterprise-kicker{font-size:11px;letter-spacing:.08em;text-transform:uppercase;color:var(--brand-2, #2563eb);font-weight:700;}',
      '.ss-enterprise-help{font-size:12px;color:var(--text-muted, #64748b);}',
      '.ss-enterprise-topline{display:flex;flex-wrap:wrap;gap:10px;padding:10px 22px;border-bottom:1px solid rgba(148,163,184,.24);background:var(--surface-1, #f8fafc);}',
      '.ss-enterprise-badge{display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border-radius:999px;background:var(--brand-10, #eff6ff);color:var(--blue-700, #1d4ed8);font-size:12px;font-weight:600;border:1px solid rgba(59,130,246,.18);}',
      '.ss-enterprise-badge.tone-danger{background:var(--red-50, #fef2f2);color:var(--red-700, #b91c1c);border-color:rgba(239,68,68,.18);}',
      '.ss-enterprise-badge.tone-success{background:var(--green-50, #f0fdf4);color:var(--green-800, #166534);border-color:rgba(34,197,94,.18);}',
      '.ss-enterprise-badge.tone-warn{background:var(--orange-50, #fff7ed);color:var(--orange-700, #c2410c);border-color:rgba(249,115,22,.18);}',
      '.ss-enterprise-tabs{display:flex;gap:8px;padding:12px 22px 0;flex-wrap:wrap;}',
      '.ss-enterprise-tab{border:1px solid rgba(148,163,184,.24);background:var(--white, #fff);padding:8px 12px;border-radius:12px;font-weight:600;color:var(--text-secondary, #334155);cursor:pointer;}',
      '.ss-enterprise-tab.active{background:var(--text-primary, #0f172a);color:var(--white, #fff);border-color:var(--text-primary, #0f172a);}',
      '.ss-enterprise-body{padding:18px 22px 22px;overflow:auto;display:flex;flex-direction:column;gap:16px;}',
      '.ss-enterprise-footer{display:flex;justify-content:flex-end;gap:10px;padding:14px 22px;border-top:1px solid rgba(148,163,184,.24);background:var(--white, #fff);}',
      '.ss-enterprise-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:12px;}',
      '.ss-enterprise-card{padding:14px;border-radius:14px;background:var(--white, #fff);border:1px solid rgba(148,163,184,.24);box-shadow:0 4px 18px rgba(15,23,42,.04);}',
      '.ss-enterprise-card-label{font-size:12px;font-weight:700;color:var(--text-muted, #64748b);text-transform:uppercase;letter-spacing:.06em;}',
      '.ss-enterprise-card-value{margin-top:8px;font-size:24px;font-weight:800;color:var(--text-primary, #0f172a);}',
      '.ss-enterprise-card-hint{margin-top:6px;font-size:12px;color:var(--text-muted, #64748b);line-height:1.45;}',
      '.ss-enterprise-section{padding:14px 16px;border-radius:14px;background:var(--white, #fff);border:1px solid rgba(148,163,184,.24);box-shadow:0 4px 18px rgba(15,23,42,.04);}',
      '.ss-enterprise-section-title{font-size:13px;font-weight:800;color:var(--text-primary, #0f172a);margin-bottom:10px;}',
      '.ss-enterprise-inline-list{display:flex;flex-wrap:wrap;gap:8px;}',
      '.ss-enterprise-empty{padding:18px;border:1px dashed rgba(148,163,184,.45);border-radius:14px;color:var(--text-muted, #64748b);background:var(--surface-1, #f8fafc);}',
      ...
      '.ss-enterprise-diff-item,.ss-enterprise-release-item,.ss-enterprise-capability-item{display:grid;grid-template-columns:minmax(200px,.9fr) minmax(0,1.6fr);gap:14px;align-items:flex-start;padding:12px 14px;border:1px solid rgba(148,163,184,.24);border-radius:14px;background:var(--white, #fff);}',
      ...
      '.ss-enterprise-loading{display:flex;align-items:center;gap:10px;padding:10px 22px;color:var(--text-secondary, #334155);}',
      '.ss-enterprise-spinner{width:14px;height:14px;border-radius:999px;border:2px solid rgba(37,99,235,.18);border-top-color:var(--brand-2, #2563eb);display:inline-block;animation:ss-enterprise-spin .7s linear infinite;}',
      ...
      '.ss-toolbar-right .ss-enterprise-toolbar-btn .ss-enterprise-toolbar-dot{width:8px;height:8px;border-radius:999px;background:var(--brand-2, #2563eb);display:inline-block;}',
