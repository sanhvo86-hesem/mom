/* ===================================================================
   ...
   HESEM MOM Portal -- MES Control Center
...
Object.assign(EXCEPTION_META, {
  ...
  dpp_readiness_gaps: { vi:'DPP readiness gaps', en:'DPP readiness gaps', icon:'🪪' },
  energy_tracking_gaps: { vi:'Energy tracking gaps', en:'Energy tracking gaps', icon:'⚡' },
  cost_variance_risk: { vi:'Cost variance risk', en:'Cost variance risk', icon:'💸' }
});
...
function ensureStyles(){
  ...
  style.textContent = [
    ...
    '.mesx-btn.primary{background:var(--amber,#f9a825);color:var(--brand,#12253a);box-shadow:0 14px 26px rgba(249,168,37,.28)}',
    ...
    '.mesx-bar > span{position:absolute;inset:0 auto 0 0;border-radius:999px;background:linear-gradient(90deg,#1f6aa5 0%,var(--amber,#f9a825) 100%)}',
    '.mesx-bar[data-band=\"strong\"] > span{background:linear-gradient(90deg,#0f9d58 0%,#34d399 100%)}',
    '.mesx-bar[data-band=\"watch\"] > span{background:linear-gradient(90deg,var(--amber-light,#f59e0b) 0%,#fbbf24 100%)}',
    ...
    '[data-color-mode="dark"] .mesx{color:#f1f5f9}',
    '[data-color-mode="dark"] .mesx-card,[data-color-mode="dark"] .mesx-panel,[data-color-mode="dark"] .mesx-modal{background:#1e293b;border-color:#334155;box-shadow:0 18px 44px rgba(0,0,0,.32)}',
    '[data-color-mode="dark"] .mesx-clock,[data-color-mode="dark"] .mesx-center,[data-color-mode="dark"] .mesx-connector,[data-color-mode="dark"] .mesx-handshake,[data-color-mode="dark"] .mesx-machine{background:linear-gradient(180deg,#162032 0%,#1e293b 100%);border-color:#334155}',
    '[data-color-mode="dark"] .mesx-kpi,[data-color-mode="dark"] .mesx-mini,[data-color-mode="dark"] .mesx-list-item,[data-color-mode="dark"] .mesx-empty,[data-color-mode="dark"] .mesx-table-wrap{background:#162032;border-color:#334155}',
    '[data-color-mode="dark"] .mesx-clock strong,[data-color-mode="dark"] .mesx-kpi strong,[data-color-mode="dark"] .mesx-panel-head h2,[data-color-mode="dark"] .mesx-panel-head h3,[data-color-mode="dark"] .mesx-center h4,[data-color-mode="dark"] .mesx-connector h4,[data-color-mode="dark"] .mesx-metric-label strong,[data-color-mode="dark"] .mesx-metric-value,[data-color-mode="dark"] .mesx-pareto-main strong,[data-color-mode="dark"] .mesx-handshake h4,[data-color-mode="dark"] .mesx-mini strong,[data-color-mode="dark"] .mesx-code,[data-color-mode="dark"] .mesx-machine h4,[data-color-mode="dark"] .mesx-list-item h4,[data-color-mode="dark"] .mesx-empty strong,[data-color-mode="dark"] .mesx-modal-head h3{color:#f1f5f9}',
    '[data-color-mode="dark"] .mesx-clock small,[data-color-mode="dark"] .mesx-kpi small,[data-color-mode="dark"] .mesx-kpi span,[data-color-mode="dark"] .mesx-panel-head p,[data-color-mode="dark"] .mesx-center p,[data-color-mode="dark"] .mesx-connector p,[data-color-mode="dark"] .mesx-metric-label span,[data-color-mode="dark"] .mesx-pareto-main span,[data-color-mode="dark"] .mesx-handshake p,[data-color-mode="dark"] .mesx-mini small,[data-color-mode="dark"] .mesx-sub,[data-color-mode="dark"] .mesx-machine p,[data-color-mode="dark"] .mesx-list-item p,[data-color-mode="dark"] .mesx-meta,[data-color-mode="dark"] .mesx-empty,[data-color-mode="dark"] .mesx-field label,[data-color-mode="dark"] .mesx-modal-head p{color:#94a3b8}',
    '[data-color-mode="dark"] .mesx-metric-row,[data-color-mode="dark"] .mesx-pareto-row,[data-color-mode="dark"] .mesx-section,[data-color-mode="dark"] .mesx-table th,[data-color-mode="dark"] .mesx-table td,[data-color-mode="dark"] .mesx-detail-table th,[data-color-mode="dark"] .mesx-detail-table td{border-color:#263348}',
    '[data-color-mode="dark"] .mesx-bar{background:#334155}',
    '[data-color-mode="dark"] .mesx-input,[data-color-mode="dark"] .mesx-select,[data-color-mode="dark"] .mesx-textarea{background:#162032;color:#f1f5f9;border-color:#475569}',
    '[data-color-mode="dark"] .mesx-table th,[data-color-mode="dark"] .mesx-detail-table th{background:#162032;color:#94a3b8}',
    '[data-color-mode="dark"] .mesx-pill{background:color-mix(in srgb, var(--pill) 18%, #0f172a);color:var(--pill)}',
    '[data-color-mode="dark"] .mesx-chip{background:rgba(59,130,246,.18);border-color:rgba(96,165,250,.26);color:#93c5fd}',
    '[data-color-mode="dark"] .mesx-chip.stone{background:#162032;border-color:#334155;color:#94a3b8}',
    '[data-color-mode="dark"] .mesx-link{background:#263348;color:#e2e8f0}',
    '[data-color-mode="dark"] .mesx-link:hover{background:#334155}',
    '[data-color-mode="dark"] .mesx-link.warning{background:rgba(217,119,6,.16);color:#fdba74}',
    '[data-color-mode="dark"] .mesx-link.danger{background:rgba(239,68,68,.16);color:#fca5a5}',
    '[data-color-mode="dark"] .mesx-x{background:#263348;color:#e2e8f0}',
...
function renderToolingCell(tooling, row){
  ...
  return badge(meta) +
    ...
    '<div class="mesx-mini-actions" style="margin-top:var(--space-2,8px)"><span>' + badge(readinessMeta) + '</span><button type="button" class="mesx-link" data-edit-tooling="' + esc(row.machine_id || '') + '">' + esc(t('Cập nhật tool', 'Update tooling')) + '</button></div>';
}
...
function renderGateQueue(rows){
  ...
  return rows.map(function(row){
    ...
    return '<div class="mesx-list-item"><h4>' + esc(row.wo_number || '') + ' · ' + esc(row.machine_id || '—') + '</h4><p>' + esc([row.customer_name || '', row.part_number || '', row.part_revision || ''].filter(Boolean).join(' · ')) + '</p><div class="mesx-meta">' + esc((row.completed_count || 0) + '/' + (row.total_required || 0) + ' · ' + t(row.summary_vi || 'Thiếu gate', row.summary_en || 'Missing gates')) + '</div><div class="mesx-mini-actions" style="margin-top:var(--space-3,10px)"><span>' + badge(meta) + '</span>' + (Array.isArray(row.missing_form_codes) ? row.missing_form_codes.map(function(code){ return '<button type="button" class="mesx-link warning" data-open-form="' + esc(code) + '" data-context="' + esc(jsonAttr(context)) + '">' + esc(code) + '</button>'; }).join('') : '') + '</div></div>';
  }).join('');
}
function renderDowntimeList(rows){
  ...
  return rows.map(function(row){
    ...
    return '<div class="mesx-list-item"><h4>' + esc(row.machine_id || '') + ' · ' + esc(row.machine_name || '') + '</h4><p>' + esc(row.reason || '') + '</p><div class="mesx-meta">' + esc([row.wo_number || '', row.category || '', row.severity || '', row.tool_id || '', fmtDateTime(row.started_at || '')].filter(Boolean).join(' · ')) + '</div><div class="mesx-mini-actions" style="margin-top:var(--space-3,10px)"><button type="button" class="mesx-link danger" data-resolve-downtime="' + esc(row.downtime_id || '') + '">' + esc(t('Khôi phục', 'Resolve')) + '</button><button type="button" class="mesx-link warning" data-open-form="FRM-512" data-context="' + esc(jsonAttr(context)) + '">' + esc(t('Mở form downtime', 'Open downtime form')) + '</button></div></div>';
  }).join('');
}
...
function renderGovernanceQueue(rows, options){
  ...
  return '<div class="mesx-list">' + rows.slice(0, 8).map(function(row){
    ...
    return '<div class="mesx-list-item"><h4>' + esc((row.wo_number || row.machine_id || row.store_key || '—') + (row.machine_id && row.wo_number ? ' · ' + row.machine_id : '')) + '</h4><p>' + esc(detail) + '</p>' + (sub ? '<div class="mesx-meta">' + esc(sub) + '</div>' : '') + '<p>' + esc(message) + '</p><div class="mesx-mini-actions" style="margin-top:var(--space-3,10px)"><span>' + badge(meta) + '</span>' + actions + '</div></div>';
  }).join('') + '</div>';
}
...
function renderCutoverAudit(audit){
  ...
  var header = '<div class="mesx-mini" style="margin:var(--space-4,14px) 0 var(--space-3,10px)"><small>' + esc(t('Cutover parity audit', 'Cutover parity audit')) + '</small><strong>' + esc([
...
function renderShadowSyncQueue(rows){
  ...
  var overview = '<div class="mesx-mini" style="margin-bottom:var(--space-3,10px)"><small>' + esc(t('Shadow sync health', 'Shadow sync health')) + '</small><strong>' + esc([
  ...
  buckets.map(function(key){
    ...
    return '<div class="mesx-mini" style="margin-bottom:var(--space-3,10px)"><small>' + esc(key) + '</small><strong>' + esc(String(bucket.last_status || 'never')) + '</strong><span class="mesx-sub">' + esc([
  ...
  var primaryOverview = '<div class="mesx-mini" style="margin:var(--space-4,14px) 0 var(--space-3,10px)"><small>' + esc(t('PostgreSQL primary-read pilot', 'PostgreSQL primary-read pilot')) + '</small><strong>' + esc([
    String(runtimeMode.mode || 'JSON_ONLY'),
  ...
  buckets.map(function(key){
    ...
    return '<div class="mesx-mini" style="margin-bottom:var(--space-3,10px)"><small>' + esc(key) + '</small><strong>' + esc(String(bucket.last_source || 'never')) + '</strong><span class="mesx-sub">' + esc([
    ...
    '<section class="mesx-hero">' +
      ...
      '<aside class="mesx-side">' +
        ...
        '<article class="mesx-card"><div class="mesx-kpi-grid">' +
          ...
          renderKpiTile(t('DPP gaps', 'DPP gaps'), kpi.dpp_readiness_gaps || 0, t('Passport số của WO còn thiếu metadata bắt buộc cho truy xuất và công bố bên ngoài', 'Digital product passports still miss governed metadata for traceability and external disclosure')) +
          renderKpiTile(t('Energy gaps', 'Energy gaps'), kpi.energy_tracking_gaps || 0, t('Thiếu power telemetry, thiếu snapshot năng lượng hoặc vượt mục tiêu kWh trên mỗi sản phẩm', 'Missing power telemetry, missing energy snapshots, or exceeded kWh-per-unit targets')) +
          renderKpiTile(t('Cost variance', 'Cost variance'), kpi.cost_variance_risk || 0, t('WO đang vượt ngưỡng cost variance hoặc còn thiếu snapshot costing', 'WO are above the governed cost variance threshold or still miss a costing snapshot')) +
          renderKpiTile(t('kWh / đơn vị', 'kWh per unit'), kpi.energy_per_unit_kwh == null ? '—' : Number(kpi.energy_per_unit_kwh).toFixed(3), t('Cường độ năng lượng trung bình từ các snapshot MES đã ghi nhận', 'Average energy intensity across governed MES snapshots')) +
...
function openToolingModal(machineId, toolRuntimeId){
  ...
  showModal(
    ...
    '<div class="mesx-form-grid">' +
      ...
      editableField('mes-tool-reset', t('Reset life', 'Reset life'), '<label class="mesx-link" style="display:flex;justify-content:flex-start;align-items:center;gap:var(--space-2,8px);background:var(--surface,#f8fafc);border:1px solid var(--border,#e2e8f0);cursor:pointer"><input id="mes-tool-reset" type="checkbox"> ' + esc(t('Đặt lại tool-life về 0 sau khi thay dao / setup lại.', 'Reset tool life to zero after replacing or reloading the tool.')) + '</label>', true) +
...
function renderDowntimePareto(rows){
  ...
  return '<div class="mesx-analytics-stack">' + rows.slice(0, 5).map(function(row){
    ...
    return '<div class="mesx-pareto-row">' +
      '<div class="mesx-pareto-main"><strong>' + esc(label) + '</strong><span>' + esc([(row.event_count || 0) + ' ' + t('sự kiện', 'events'), (row.open_count || 0) + ' ' + t('đang mở', 'open'), (row.major_count || 0) + ' ' + t('mức major+', 'major+'), metaLine].filter(Boolean).join(' · ')) + '</span><div class="mesx-bar" data-band="' + esc(band) + '" style="margin-top:var(--space-2,8px)"><span style="width:' + esc(String(Math.max(0, Math.min(100, Number(row.share_pct || 0))))) + '%"></span></div></div>' +
