  ...
  function renderTypographyTab(L, t){
    return ''
      + renderRow(L('Font family','Font family'),
          '<select id="theme-font-family" style="width:300px;height:32px;padding:0 8px;border:1px solid var(--o3-border-subtle);border-radius:6px;font-size:12px">'
      ...
      + renderRow(L('Cỡ chữ chuẩn','Base font size'),
          '<input type="number" id="theme-font-base" value="' + t['font-base'] + '" min="11" max="16" step="1" style="width:64px;height:32px;padding:0 6px;border:1px solid var(--o3-border-subtle);border-radius:6px;font-size:12px">'
