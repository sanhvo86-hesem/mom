/* ===================================================================
   ...
   HESEM MOM Portal - Exception Dashboard
...
function ensureStyles(){
  ...
  style.textContent = [
    ...
    '.excx-btn.primary{background:var(--amber,#f9a825);color:var(--brand,#12253a);box-shadow:0 14px 26px rgba(249,168,37,.28)}',
    ...
    '.excx-sev-warn{background:var(--yellow-bg,#fffbeb);color:#d97706;border:1px solid #fde68a}',
