...
function _paint(){
  ...
  html+='<div style="background:var(--yellow-bg,#fffbeb);border:1px solid var(--amber-light,#f59e0b);border-radius:8px;padding:10px 14px;margin-bottom:12px;display:flex;align-items:center;gap:10px;flex-wrap:wrap">'
    ...
    +'<button onclick="window.navigateTo&&navigateTo(\'eqms\')" style="background:var(--amber-light,#f59e0b);color:#fff;border:none;border-radius:6px;padding:6px 12px;cursor:pointer;font-weight:600;white-space:nowrap">'+_t('Mở EQMS Suite →','Open EQMS Suite →')+'</button>'
    +'</div>';
