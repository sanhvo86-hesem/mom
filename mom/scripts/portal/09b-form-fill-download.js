/* ═══════════════════════════════════════════════════
   ...
   HESEM MOM Portal — Unified allocate + fill + download + upload + sign
   ═══════════════════════════════════════════════════ */
...
var HEADER_ROLE_META = {
  ceo: { code:'CEO', href:'../mom/docs/system/organization/03-Job-Descriptions/01-JD-Executive/jd-chief-executive-officer.html' },
  production_director: { code:'PD', href:'../mom/docs/system/organization/03-Job-Descriptions/01-JD-Executive/jd-production-director.html' },
  cnc_workshop_manager: { code:'WKM', href:'../mom/docs/system/organization/03-Job-Descriptions/02-JD-Production/jd-cnc-workshop-manager.html' },
  production_planner: { code:'PPL', href:'../mom/docs/system/organization/03-Job-Descriptions/02-JD-Production/jd-production-planner.html' },
  shift_leader: { code:'SL', href:'../mom/docs/system/organization/03-Job-Descriptions/02-JD-Production/jd-shift-leader.html' },
  engineering_lead: { code:'ENGM', href:'../mom/docs/system/organization/03-Job-Descriptions/03-JD-Engineering/jd-engineering-lead-manager.html' },
  process_engineer: { code:'PE', href:'../mom/docs/system/organization/03-Job-Descriptions/03-JD-Engineering/jd-process-engineer.html' },
  cam_nc_programmer: { code:'CAM', href:'../mom/docs/system/organization/03-Job-Descriptions/03-JD-Engineering/jd-cam-nc-programmer.html' },
  qa_manager: { code:'QA', href:'../mom/docs/system/organization/03-Job-Descriptions/04-JD-Quality/jd-qa-manager.html' },
  quality_engineer: { code:'QE', href:'../mom/docs/system/organization/03-Job-Descriptions/04-JD-Quality/jd-quality-engineer.html' },
  qms_engineer: { code:'QMS', href:'../mom/docs/system/organization/03-Job-Descriptions/04-JD-Quality/jd-qms-engineer.html' },
  supply_chain_manager: { code:'SCM', href:'../mom/docs/system/organization/03-Job-Descriptions/05-JD-Supply-Chain/jd-supply-chain-manager.html' },
  buyer: { code:'BUY', href:'../mom/docs/system/organization/03-Job-Descriptions/05-JD-Supply-Chain/jd-buyer-purchasing.html' },
  customer_service: { code:'CS', href:'../mom/docs/system/organization/03-Job-Descriptions/06-JD-Sales/jd-customer-service.html' },
  estimator: { code:'EST', href:'../mom/docs/system/organization/03-Job-Descriptions/06-JD-Sales/jd-estimator.html' },
  finance_manager: { code:'FIN', href:'../mom/docs/system/organization/03-Job-Descriptions/07-JD-Finance/jd-finance-manager.html' },
  hr_manager: { code:'HR', href:'../mom/docs/system/organization/03-Job-Descriptions/08-JD-HR/jd-hr-manager.html' },
  ehs_specialist: { code:'EHS', href:'../mom/docs/system/organization/03-Job-Descriptions/09-JD-EHS/jd-ehs-specialist.html' },
  it_admin: { code:'ITA', href:'../mom/docs/system/organization/03-Job-Descriptions/10-JD-IT/jd-it-admin.html' }
};

var HEADER_DEPARTMENT_META = {
  EXE: { code:'D-EXE', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-executive-handbook.html' },
  PRO: { code:'D-PROD', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-production-handbook.html' },
  ENG: { code:'D-ENG', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-engineering-handbook.html' },
  QA: { code:'D-QUAL', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-quality-handbook.html' },
  SCM: { code:'D-SCM', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-supply-chain-handbook.html' },
  SAL: { code:'D-SAL', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-sales-and-customer-service-handbook.html' },
  FIN: { code:'D-FIN', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-finance-handbook.html' },
  HR: { code:'D-HR', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-hr-handbook.html' },
  EHS: { code:'D-EHS', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-ehs-handbook.html' },
  IT: { code:'D-IT', href:'../mom/docs/system/organization/02-Department-Handbooks/dept-it-handbook.html' }
};
...
/* ── Step 2: Fill form (online, standalone, or offline) ── */
