/* ===================================================================
   ...
   HESEM MOM Portal - Compliance Report Generation
...
function _ensureStyles(){
  ...
  s.textContent=[
    ...
    '.cr-badge{display:inline-block;padding:2px 10px;border-radius:999px;font-size:.6875rem;font-weight:700;color:var(--text-inverse,#fff);white-space:nowrap}',
    ...
    '.cr-btn-primary{background:var(--brand,#1565c0);color:var(--text-inverse,#fff)}',
    ...
    '.cr-btn-secondary:hover{background:var(--border,#e2e8f0)}',
    '.cr-btn-success{background:var(--green,#22c55e);color:var(--text-inverse,#fff)}',
    '.cr-btn-success:hover{background:var(--green-dark,#16a34a)}',
    ...
    '.cr-bar-fill{height:100%;border-radius:4px;transition:width .4s ease;display:flex;align-items:center;justify-content:flex-end;padding-right:6px;font-size:.6875rem;font-weight:700;color:var(--text-inverse,#fff);min-width:2px}',
    ...
    '.cr-spinner{display:inline-block;width:16px;height:16px;border:2px solid rgba(255,255,255,.3);border-top-color:var(--text-inverse,#fff);border-radius:50%;animation:cr-spin .6s linear infinite}',
