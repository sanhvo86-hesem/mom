...
**Migration range**: 001–286 (263 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–286_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Registry contract table count: 955
