...
**Declared**: 2026-04-13
**Scope**: Platform-global (660 tables)
**Migration range**: 001–098 (98 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–098_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE count: 674
