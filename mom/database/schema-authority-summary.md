...
**Declared**: 2026-05-14
**Scope**: Platform-global (867 tables)
**Migration range**: 001–183 (183 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–183_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE statement count: 884
- Snapshot unique physical table count: 880
- Snapshot logical runtime-contract table count: 867
- Snapshot partition table count: 13
- Registry contract table count: 867
