...
**Declared**: 2026-04-13
**Scope**: Platform-global (659 tables)
**Migration range**: 001–097 (97 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–097_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE count: 673
