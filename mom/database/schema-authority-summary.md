...
**Declared**: 2026-04-14
**Scope**: Platform-global (761 tables)
**Migration range**: 001–131 (133 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–131_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE statement count: 776
- Snapshot unique physical table count: 774
- Snapshot logical runtime-contract table count: 761
- Snapshot partition table count: 13
- Registry contract table count: 761
