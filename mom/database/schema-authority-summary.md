...
**Declared**: 2026-04-15
**Scope**: Platform-global (764 tables)
**Migration range**: 001–135 (137 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–135_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE statement count: 779
- Snapshot unique physical table count: 777
- Snapshot logical runtime-contract table count: 764
- Snapshot partition table count: 13
- Registry contract table count: 764
