...
**Migration range**: 001–122 (124 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–122_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
