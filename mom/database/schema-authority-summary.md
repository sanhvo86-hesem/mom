...
**Declared**: 2026-04-07
**Scope**: Platform-global (628 tables)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–079_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- `table-registry.json` derives from `schema.sql` via `generate-table-architecture.mjs`.
