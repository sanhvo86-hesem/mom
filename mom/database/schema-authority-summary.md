...
**Declared**: 2026-05-16
**Scope**: Platform-global (869 tables)
**Migration range**: 001–187 (187 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–187_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE statement count: 894
- Snapshot unique physical table count: 890
- Snapshot logical runtime-contract table count: 869
- Snapshot partition table count: 21
- Registry contract table count: 869
