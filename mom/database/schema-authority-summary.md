...
**Declared**: 2026-04-15
**Scope**: Platform-global (800 tables)
**Migration range**: 001–136 (138 migrations)

## Authority Chain

| Layer | File | Role |
|-------|------|------|
| **Executable Source of Truth** | `database/migrations/001–136_*.sql` | Sequential DDL. Applied in order. This IS the schema. |
...
- Snapshot CREATE TABLE statement count: 815
- Snapshot unique physical table count: 813
- Snapshot logical runtime-contract table count: 800
