...
After deploy, direct browser access to the JSON manifest returned HTTP 403. The dashboard was repaired to remove the dead hyperlink. The manifest remains tracked and present on the server for machine verification.
