...
- Migration `275_uom_system_ssot_closure.sql` gives cost, shipment, tooling preset, and tooling life records UOM evidence columns and governed generic CRUD guard coverage.
