...
- Added migration 271 with idempotency columns, projection write guard, reconciliation tables, period close table, recall trace export table, generic CRUD registry rows, and regulated action policies.
...
- `mom/database/migrations/271_inventory_ledger_runtime_authority.sql`
