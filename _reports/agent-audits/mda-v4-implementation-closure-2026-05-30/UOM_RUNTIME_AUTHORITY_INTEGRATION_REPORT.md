...
- Added `mom/api/services/DomainCommand/UomCommandQuantityNormalizer.php` and `mom/database/migrations/269_uom_domain_command_runtime_authority.sql`.
...
- Added migration `275_uom_system_ssot_closure.sql` for system-wide UOM evidence columns and governed registry coverage.
