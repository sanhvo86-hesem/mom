...
Generated: 2026-05-21T14:51:16+00:00
...
| `metric_codes_seen` | 127 |
| `executive_scorecard_metrics_seen` | 13 |
...
|---|---|---:|---:|---|---|---|---|
| `OTD` | executive_scorecard_kpi | 147 | 389 | ≥95% | runtime_calculated_with_registry_contract | target_seen_matches_registry_number | canonical_or_mapped_name |
| `FPY` | executive_scorecard_kpi | 48 | 70 | ≥98% | runtime_calculated_with_registry_contract | target_seen_matches_registry_number | canonical_or_mapped_name |
...
| `INVENTORY_ACCURACY` | governance_kpi | 9 | 10 |  | candidate_data_contract_required_before_payout | local_target_requires_classification | canonical_or_mapped_name |
...
| `PLAN_ADHERENCE` | governance_kpi | 5 | 8 |  | candidate_data_contract_required_before_payout | no_registered_target_no_local_target | canonical_or_mapped_name |
...
| `FAI_FIRST_PASS` | executive_scorecard_kpi | 2 | 2 | ≥98% | candidate_data_contract_required_before_payout | registered_target_not_repeated_in_docs | canonical_or_mapped_name |
