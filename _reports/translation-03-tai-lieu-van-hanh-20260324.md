...
- `hold_point`: 10
- `cleanup_audit_trail_duplicate`: 1
- `right_first_time`: 1

## Top Changed Files

- `03-Tai-Lieu-Van-Hanh/01-SOPs/01-SOP-100/sop-104-data-governance-records-security-and-ip-protection.html`: 1 thay thế (cleanup_audit_trail_duplicate=1)
- `03-Tai-Lieu-Van-Hanh/01-SOPs/03-SOP-300/sop-302-first-article-inspection-fai.html`: 1 thay thế (hold_point=1)
- `03-Tai-Lieu-Van-Hanh/02-Work-Instructions/01-WI-100/wi-101-digital-online-forms-and-approvals.html`: 1 thay thế (hold_point=1)
...
- `03-Tai-Lieu-Van-Hanh/03-Reference/06-ANNEX-600/annex-603-quality-package-levels-qpl.html`: 1 thay thế (hold_point=1)
- `03-Tai-Lieu-Van-Hanh/03-Reference/08-ANNEX-800/annex-801-competency-levels-and-certification-rules.html`: 1 thay thế (right_first_time=1)
