...
- 0 entries are missing the third-line description after the `00-FORM-DESIGN-SYSTEM` folder metadata was added.

## Follow-up recommendation

The `04-Bieu-Mau/00-FORM-DESIGN-SYSTEM` documents now render a generic Vietnamese third line from folder metadata. If any of these need a more specific description, add per-document entries in [doc_descriptions.json](/C:/Users/TEST4/qms-data-private/config/doc_descriptions.json):
